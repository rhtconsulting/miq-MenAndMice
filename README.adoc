:project-name: miq-MenAndMice
:project-repo: https://github.com/rhtconsulting/miq-MenAndMice
:project-zip: https://github.com/rhtconsulting/miq-MenAndMice/archive/master.zip
